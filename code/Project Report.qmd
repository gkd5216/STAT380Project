...
The dataset used for this analysis, the ***Drug Reviews*** dataset from the UC Irvine Repository [^1], explores reviews from patients on specific drugs along with related medical conditions. It includes structured data such as the **urlDrugName**, **condition**, **rating**, **effectiveness**, and **sideEffects**, as well as text reviews such as **benefitsReview**, **sideEffectsReview**, and **commentsReview**.

[^1]: Kallumadi, S. & Grer, F. (2018). Drug Reviews (Druglib.com) \[Dataset\]. UCI Machine Learning Repository. https://doi.org/10.24432/C55G6J.
